...
const GAMES = [
    ...
    },
    {
        id: "racing",
        name: "Racing 2D",
        icon: "assets/racing-2d-icon.png"
    },
    {
        id: "memory",
        name: "Memory",
    ...
    },
    {
        ...
        icon: "assets/prepara-la-pizza-icon.png"
    },
    {
        id: "balloons",
        name: "Scoppia i Palloncini",
        icon: "assets/scoppia-i-palloncini-icon.png"
    },
    {
        id: "aquarium",
        name: "Acquario Magico",
        icon: "assets/acquario-magico-icon.png"
    }
];
                        ...
                        <div class="panel-header">
                            ...
                            <div class="panel-title">
                                ...
                                <div class="panel-title-icon">
                                    ${getGameIconMarkup(game.game_id)}
                                </div>
...
function getGameIconMarkup(gameId) {
    const icon = getGameIcon(gameId);
    if (/^(?:\.\/)?assets\/[a-z0-9_./-]+\.(?:svg|png|webp)$/i.test(icon)) {
        return `<img src="../${escapeHtml(icon.replace(/^\.\//, ""))}" alt="">`;
    }
...
const ADMIN_V2_GAME_META = [
    { id: "tris", name: "Tris", icon: "assets/tris-icon.png", category: "Party", path: "games/tris.html", description: "Sfida un amico o affronta il computer nel classico gioco del Tris." },
    { id: "uno", name: "UNO", icon: "assets/uno-icon.png", category: "Party", path: "games/uno.html", description: "Gioca a UNO con i tuoi amici online e sfidali in stanze private.", multiplayer: true, rooms: true },
    { id: "racing", name: "Racing 2D", icon: "assets/racing-2d-icon.png", category: "Arcade", path: "games/racing.html", description: "Corri, schiva gli ostacoli e raggiungi il traguardo nel minor tempo possibile." },
    { id: "memory", name: "Memory", icon: "assets/memory-icon.png", category: "Puzzle", path: "games/memory.html", description: "Trova tutte le coppie di carte nel minor numero di mosse possibile." },
    { id: "pizza", name: "Prepara la Pizza", icon: "assets/prepara-la-pizza-icon.png", category: "Cucina", path: "games/pizza.html", description: "Prepara gli ordini dei clienti, cucina le pizze e guadagna!" },
    { id: "balloons", name: "Scoppia i Palloncini", icon: "assets/scoppia-i-palloncini-icon.png", category: "Arcade", path: "games/balloons.html", description: "Scoppia più palloncini possibile prima che il tempo finisca." },
    { id: "aquarium", name: "Acquario Magico", icon: "assets/acquario-magico-icon.png", category: "Relax", path: "games/aquarium.html", description: "Esplora l'acquario, raccogli stelle magiche e trova tesori nascosti." },
    { id: "undercover", name: "Undercover", icon: "assets/undercover-icon.png", category: "Party", path: "games/undercover.html", description: "Scopri chi ha una parola diversa, sullo stesso telefono oppure online.", multiplayer: true, rooms: true },
    { id: "block-blast", name: "Block Blast", icon: "assets/block-blast-icon.png", category: "Puzzle", path: "games/block-blast.html", description: "Posiziona i blocchi, completa righe e colonne e cerca di ottenere il punteggio più alto." },
    { id: "tetris", name: "Tetris", icon: "assets/tetris-icon.png", category: "Puzzle", path: "games/tetris.html", description: "Incastra i tetramini, completa le righe e resisti mentre la velocità aumenta." },
    { id: "wordle", name: "Wordle", icon: "assets/wordle-icon.png", category: "Parole", path: "games/wordle.html", description: "Indovina la parola italiana di cinque lettere in sei tentativi." },
    { id: "reaction-time", name: "Reaction Time", icon: "assets/reaction-time-icon.png", category: "Arcade", path: "games/reaction-time.html", description: "Attendi il segnale, poi reagisci più velocemente possibile." },
    { id: "color-match", name: "Color Match", icon: "assets/color-match-icon.png", category: "Reflex", path: "games/color-match.html", description: "Sfida l'effetto Stroop: scegli il colore del testo, non la parola." },
    { id: "hangman", name: "Impiccato", icon: "assets/impiccato-icon.png", category: "Parole", path: "games/hangman.html", description: "Scopri la parola prima che il disegno dell'impiccato sia completo." },
    { id: "snake", name: "Snake", icon: "assets/snake-icon.png", category: "Arcade", path: "games/snake.html", description: "Mangia il cibo, cresci e supera il tuo record senza colpire il corpo." },
    { id: "sliding-puzzle", name: "Sliding Puzzle", icon: "assets/sliding-puzzle-icon.png", category: "Puzzle", path: "games/sliding-puzzle.html", description: "Riordina le tessere numerate scegliendo la difficoltà che preferisci." },
    { id: "number-merge", name: "Number Merge", icon: "assets/number-merge-icon.png", category: "Puzzle", path: "games/number-merge.html", description: "Unisci le tessere uguali e prova a creare il 2048." },
    { id: "water-sort", name: "Water Sort", icon: "assets/water-sort-icon.png", category: "Puzzle", path: "games/water-sort.html", description: "Ordina l'acqua colorata finché ogni provetta contiene un solo colore." },
    { id: "darts", name: "Darts", icon: "assets/darts-icon.png", category: "Arcade", path: "games/darts.html", description: "Mira, lancia e chiudi la partita nel classico gioco delle freccette." },
    { id: "cube-rush", name: "Cube Rush", icon: "◆", category: "Arcade", path: "games/cube-rush.html", description: "Corri, salta e cambia forma attraverso tre livelli costruiti intorno al ritmo." },
    { id: "indovina-chi", name: "Indovina Chi", icon: "assets/indovina-chi-icon.png", category: "Party", path: "games/indovina-chi.html", description: "Fai domande, elimina i sospetti e scopri il personaggio segreto del tuo avversario prima che lui scopra il tuo.", multiplayer: true, rooms: true },
    { id: "gatto-topo", name: "Gatto e Topo", icon: "assets/gatto-topo-icon.png", category: "Arcade", path: "games/gatto-topo.html", description: "Tocca al momento giusto, fai scattare la zampa e prova a catturare il topo prima che scappi." }
];

const ADMIN_V2_ICON_OVERRIDES = Object.freeze({
    tris: "assets/tris-icon.png",
    uno: "assets/uno-icon.png",
    racing: "assets/racing-2d-icon.png",
    memory: "assets/memory-icon.png",
    pizza: "assets/prepara-la-pizza-icon.png",
    balloons: "assets/scoppia-i-palloncini-icon.png",
    aquarium: "assets/acquario-magico-icon.png",
    undercover: "assets/undercover-icon.png",
    "block-blast": "assets/block-blast-icon.png",
    tetris: "assets/tetris-icon.png",
    wordle: "assets/wordle-icon.png",
    "reaction-time": "assets/reaction-time-icon.png",
    "color-match": "assets/color-match-icon.png",
    hangman: "assets/impiccato-icon.png",
    snake: "assets/snake-icon.png",
    "sliding-puzzle": "assets/sliding-puzzle-icon.png",
    "number-merge": "assets/number-merge-icon.png",
    "water-sort": "assets/water-sort-icon.png",
    darts: "assets/darts-icon.png",
    "polizia-ladri": "assets/polizia-ladri-icon.png",
    "indovina-chi": "assets/indovina-chi-icon.png",
    "gatto-topo": "assets/gatto-topo-icon.png"
});

const adminV2SelectedGameIds = new Set();
...
function adminV2CanonicalGameIndex(gameId) {
    // Polizia e Ladri è un record dinamico del catalogo Supabase e non ha file
    // statici in questo checkout: conserva comunque il suo posto prima del
    // nuovo Indovina Chi.
    if (gameId === "polizia-ladri") {
        const guessWhoIndex = ADMIN_V2_GAME_META.findIndex(item => item.id === "indovina-chi");
        return (guessWhoIndex >= 0 ? guessWhoIndex : ADMIN_V2_GAME_META.length) - .5;
    }
    const index = ADMIN_V2_GAME_META.findIndex(item => item.id === gameId);
    return index >= 0 ? index : Number.MAX_SAFE_INTEGER;
}

function adminV2AdditionOrderForGame(game) {
    const canonical = adminV2CanonicalGameIndex(game?.game_id);
    if (canonical < ADMIN_V2_GAME_META.length) return canonical;
    const created = game?.created_at ? new Date(game.created_at).getTime() : Number.MAX_SAFE_INTEGER;
    return ADMIN_V2_GAME_META.length + (Number.isFinite(created) ? created / 1e13 : 999999);
}

function adminV2NormalizeGame(game) {
    const meta = adminV2Meta(game.game_id);
    const storedIcon = String(game.icon ?? "").trim();
    const rawStatus = ADMIN_V2_STATUSES.includes(game.status) ? game.status : "available";
    const status = rawStatus === "coming_soon" || rawStatus === "maintenance"
        ? rawStatus
    ...
    return {
        ...
        icon: ADMIN_V2_ICON_OVERRIDES[game.game_id] || storedIcon || meta.icon || "🎮",
        path: game.path ?? meta.path,
        description: game.description ?? meta.description,
        category: String(game.category ?? "").trim() ? game.category : meta.category,
        status,
...
function adminV2EffectiveStatus(game, now = new Date()) {
    const declaredStatus = ADMIN_V2_STATUSES.includes(game.status) ? game.status : "available";
    if (declaredStatus === "maintenance") return "maintenance";
    if (declaredStatus === "coming_soon") {
        if (game.auto_release && game.scheduled_release_at && new Date(game.scheduled_release_at).getTime() <= now.getTime()) return "available";
        return "coming_soon";
    }
    return game.enabled === false ? "maintenance" : "available";
}
...
async function makeAllGamesAvailable() {
    ...
    try {
        const result = await adminV2UpsertAllCatalogGames({ status: "available", enabled: true });
        const settings = await updateSettings({ global_games_locked: false });
        if (!settings || settings.global_games_locked === true) {
            throw new Error("Il blocco globale dei giochi non è stato disattivato.");
        }
        ...
        await writeAdminLog(
            ...
            "site_games",
            null,
            { status: "available", enabled: true, updated_games: result.length }
        );
...
async function makeAllGamesMaintenance() {
    ...
    try {
        const settings = await updateSettings({ global_games_locked: true });
        if (!settings || settings.global_games_locked !== true) {
            throw new Error("Il blocco globale dei giochi non è stato attivato.");
        }
        const result = await adminV2UpsertAllCatalogGames({ status: "maintenance", enabled: false });
        ...
        await writeAdminLog(
            ...
            "site_games",
            null,
            { status: "maintenance", enabled: false, updated_games: result.length }
        );
...
function getStatusLabel() {
    ...
    if (settings.global_games_locked) return "GIOCHI BLOCCATI";
...
async function loadGames() {
    try {
        ...
        state.games.sort((a, b) => adminV2AdditionOrderForGame(a) - adminV2AdditionOrderForGame(b) || String(a.game_id).localeCompare(String(b.game_id), "it"));
        renderGames();
        renderStatsGames();
...
function renderBulkGameActions() {
    const selectedIds = Array.from(adminV2SelectedGameIds).filter(id => (state.games || []).some(game => game.game_id === id));
    adminV2SelectedGameIds.clear();
    selectedIds.forEach(id => adminV2SelectedGameIds.add(id));
    const panel = $("gamesBulkActions");
    if (panel) panel.hidden = selectedIds.length === 0;
    setText("gamesSelectionCount", String(selectedIds.length));
}

function adminV2CatalogPayload(game, changes) {
    const next = { ...game, ...changes };
    if (Object.prototype.hasOwnProperty.call(changes, "status")) next.enabled = changes.status === "available";
    return {
        ...
        badge: next.badge ?? "",
        badge_expires_at: next.badge_expires_at || null,
        release_date: next.release_date || null,
        release_time: next.release_time || null,
        sort_order: Number(next.sort_order) || 0,
        maintenance_message: next.maintenance_message ?? "",
        disabled_message: next.disabled_message ?? "",
        scheduled_release_at: next.scheduled_release_at || null,
        auto_release: Boolean(next.auto_release),
        multiplayer_enabled: Boolean(next.multiplayer_enabled),
        new_rooms_enabled: Boolean(next.new_rooms_enabled)
    };
}

function adminV2ReadBulkAllGameChanges() {
    const changes = {};
    const addText = (key, id) => {
    ...
    const path = $("bulkGamePath")?.value.trim() || "";
    if (path && (path.startsWith("http") || path.includes("..") || !path.endsWith(".html"))) {
        throw new Error("Il percorso deve essere un file HTML locale, senza URL esterni o '..'.");
    }

    addText("name", "bulkGameName");
    addText("icon", "bulkGameIcon");
    addText("category", "bulkGameCategory");
    if (path) changes.path = path;
    addText("description", "bulkGameDescription");
    addText("badge", "bulkGameBadge");
    addRaw("release_date", "bulkGameReleaseDate");
    addRaw("release_time", "bulkGameReleaseTime");

    const badgeExpiry = $("bulkGameBadgeExpiresAt")?.value || "";
    if (badgeExpiry) changes.badge_expires_at = adminV2IsoInput(badgeExpiry);
    const maintenanceMessage = $("bulkGameMaintenanceMessage")?.value.trim() || "";
    if (maintenanceMessage) {
        changes.maintenance_message = maintenanceMessage;
        changes.disabled_message = maintenanceMessage;
    }
    const scheduledRelease = $("bulkScheduledReleaseAt")?.value || "";
    if (scheduledRelease) changes.scheduled_release_at = adminV2IsoInput(scheduledRelease);

    const status = $("bulkGameStatus")?.value || "";
    if (ADMIN_V2_STATUSES.includes(status)) changes.status = status;
    const visible = $("bulkGameVisible")?.value || "";
    if (visible) changes.visible = visible === "true";
    const multiplayer = $("bulkMultiplayer")?.value || "";
    if (multiplayer) changes.multiplayer_enabled = multiplayer === "true";
    const newRooms = $("bulkNewRooms")?.value || "";
    if (newRooms) changes.new_rooms_enabled = newRooms === "true";
    const autoRelease = $("bulkAutoRelease")?.value || "";
    if (autoRelease) changes.auto_release = autoRelease === "true";
    return changes;
}

async function applyBulkGameChanges(changes, actionLabel) {
    const selected = (state.games || []).filter(game => adminV2SelectedGameIds.has(game.game_id));
    if (!selected.length) { showToast("Seleziona almeno un gioco.", "error"); return; }
    if (!changes || !Object.keys(changes).length) { showToast("Compila almeno un campo da modificare.", "error"); return; }
    const confirmed = await adminV2ConfirmAction({
        title: "Applicare la modifica ai giochi selezionati?",
        message: `${actionLabel} verrà applicato a ${selected.length} giochi.`,
        confirmLabel: "APPLICA",
        icon: "🎮"
    });
    if (!confirmed) return;
    try {
        const results = await Promise.all(selected.map(game => adminDb
            .from(ADMIN_V2_TABLES.games)
            .upsert(adminV2CatalogPayload(game, changes), { onConflict: "game_id" })
            .select("game_id")));
        const failed = results.find(result => result.error);
        if (failed?.error) throw failed.error;
        await Promise.all(selected.map(game => writeAdminLog("Aggiornamento multiplo giochi", "site_games", game.game_id, changes)));
        adminV2SelectedGameIds.clear();
        await loadGames();
        showToast(`✅ Modifica applicata a ${selected.length} giochi.`);
    } catch (error) {
        handleError(error, "Impossibile aggiornare i giochi selezionati.");
    }
}
...
function renderGames() {
        ...
        return `
            <article class="admin-game-card admin-v2-game-card ${game.visible ? "" : "is-hidden"}" data-game-id="${escapeHtml(game.game_id)}">
                <div class="admin-game-card-header">
                    <div class="admin-game-card-icon">${adminV2GameIconMarkup(game.icon)}</div>
                    ...
                    <label class="admin-game-select" title="Seleziona ${escapeHtml(game.name)}">
                        <input type="checkbox" data-game-select aria-label="Seleziona ${escapeHtml(game.name)}" ${adminV2SelectedGameIds.has(game.game_id) ? "checked" : ""}>
                    </label>
                </div>
    ...
    renderBulkGameActions();
}

function adminV2GameIconMarkup(value) {
...
async function updateGame(gameId, changes, legacyValue) {
    ...
    try {
        const currentGame = (state.games || []).find(game => game.game_id === gameId);
        const databasePayload = currentGame
            ? adminV2CatalogPayload(currentGame, payload)
            : { game_id: gameId, ...payload };
        // I giochi presenti solo nel catalogo statico (come un nuovo gioco)
        // possono non avere ancora una riga in site_games. Upsert senza
        // single() gestisce sia la prima creazione sia le modifiche successive
        // anche quando Supabase non restituisce una rappresentazione del record.
        const result = await adminDb
            .from(ADMIN_V2_TABLES.games)
            .upsert(databasePayload, { onConflict: "game_id" });
        if (result.error) throw result.error;
...
async function adminV2UpsertAllCatalogGames(changes) {
    const games = state.games || [];
    const results = await Promise.all(games.map(game => adminDb
        .from(ADMIN_V2_TABLES.games)
        .upsert(adminV2CatalogPayload(game, changes), { onConflict: "game_id" })));
    const failed = results.find(result => result.error);
    if (failed?.error) throw failed.error;
...
async function saveGameFromEditor() {
    ...
    try {
        ...
        // Un gioco statico può essere visibile nell'Admin prima della sua
        // prima persistenza su Supabase: usa sempre upsert per non fallire con
        // "Cannot coerce the result to a single JSON object" su UPDATE vuoto.
        const result = await adminDb
            .from(ADMIN_V2_TABLES.games)
...
function bindAdminV2Controls() {
    ...
    $("gamesGrid")?.addEventListener("change", event => {
        const card = event.target.closest("[data-game-id]");
        if (!card) return;
        if (event.target.matches("[data-game-select]")) {
            if (event.target.checked) adminV2SelectedGameIds.add(card.dataset.gameId);
            else adminV2SelectedGameIds.delete(card.dataset.gameId);
            renderBulkGameActions();
            return;
        }
    ...
    $("clearGamesSelectionButton")?.addEventListener("click", () => { adminV2SelectedGameIds.clear(); renderGames(); });
    $("bulkStatusApply")?.addEventListener("click", () => {
        const selectedStatus = $("bulkGameStatus")?.value || "";
        applyBulkGameChanges(ADMIN_V2_STATUSES.includes(selectedStatus) ? { status: selectedStatus } : {}, "Lo stato scelto");
    });
    $("bulkBadgeApply")?.addEventListener("click", () => {
        const changes = {};
        const badge = $("bulkGameBadge")?.value.trim() || "";
        const expiry = $("bulkGameBadgeExpiresAt")?.value || "";
        if (badge) changes.badge = badge;
        if (expiry) changes.badge_expires_at = adminV2IsoInput(expiry);
        applyBulkGameChanges(changes, "Il badge scelto");
    });
    $("bulkMultiplayerApply")?.addEventListener("click", () => {
        const value = $("bulkMultiplayer")?.value || "";
        applyBulkGameChanges(value ? { multiplayer_enabled: value === "true" } : {}, "La scelta multiplayer");
    });
    $("bulkScheduleApply")?.addEventListener("click", () => {
        const changes = {};
        const scheduled = $("bulkScheduledReleaseAt")?.value || "";
        const autoRelease = $("bulkAutoRelease")?.value || "";
        if (scheduled) changes.scheduled_release_at = adminV2IsoInput(scheduled);
        if (autoRelease) changes.auto_release = autoRelease === "true";
        applyBulkGameChanges(changes, "La programmazione di rilascio");
    });
    $("bulkApplyAll")?.addEventListener("click", () => {
        try {
            applyBulkGameChanges(adminV2ReadBulkAllGameChanges(), "Le modifiche compilate");
        } catch (error) {
            handleError(error, "Controlla i campi della modifica multipla.");
        }
    });
