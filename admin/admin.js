...
const ADMIN_V2_GAME_META = [
    ...
    { id: "wordle", name: "Wordle", icon: "W", category: "Parole", path: "games/wordle.html", description: "Indovina la parola italiana di cinque lettere in sei tentativi." },
    { id: "reaction-time", name: "Reaction Time", icon: "⚡", category: "Arcade", path: "games/reaction-time.html", description: "Attendi il segnale, poi reagisci più velocemente possibile." },
    { id: "color-match", name: "Color Match", icon: "A", category: "Reflex", path: "games/color-match.html", description: "Sfida l'effetto Stroop: scegli il colore del testo, non la parola." },
    { id: "hangman", name: "Impiccato", icon: "⌁", category: "Parole", path: "games/hangman.html", description: "Scopri la parola prima che il disegno dell'impiccato sia completo." },
    { id: "snake", name: "Snake", icon: "●", category: "Arcade", path: "games/snake.html", description: "Mangia il cibo, cresci e supera il tuo record senza colpire il corpo." },
    { id: "sliding-puzzle", name: "Sliding Puzzle", icon: "▦", category: "Puzzle", path: "games/sliding-puzzle.html", description: "Riordina le tessere numerate scegliendo la difficoltà che preferisci." },
    { id: "number-merge", name: "Number Merge", icon: "2²", category: "Puzzle", path: "games/number-merge.html", description: "Unisci le tessere uguali e prova a creare il 2048." },
    { id: "water-sort", name: "Water Sort", icon: "🧪", category: "Puzzle", path: "games/water-sort.html", description: "Ordina l'acqua colorata finché ogni provetta contiene un solo colore." },
    { id: "darts", name: "Darts", icon: "🎯", category: "Arcade", path: "games/darts.html", description: "Mira, lancia e chiudi la partita nel classico gioco delle freccette." },
    ...
    { id: "indovina-chi", name: "Indovina Chi", icon: "assets/indovina-chi-icon.svg", category: "Party", path: "games/indovina-chi.html", description: "Fai domande, elimina i sospetti e scopri il personaggio segreto del tuo avversario prima che lui scopra il tuo.", multiplayer: true, rooms: true }
];

const ADMIN_V2_ICON_OVERRIDES = Object.freeze({
    "polizia-ladri": "assets/polizia-ladri-icon.svg",
    "indovina-chi": "assets/indovina-chi-icon.svg"
});
...
function adminV2CanonicalGameIndex(gameId) {
    ...
    // nuovo Indovina Chi.
    if (gameId === "polizia-ladri") return ADMIN_V2_GAME_META.length - 1.5;
...
function adminV2NormalizeGame(game) {
    ...
    return {
        ...
        icon: storedIcon && !(/^(?:◉|●|PL|P\s*L)$/i.test(storedIcon) && ADMIN_V2_ICON_OVERRIDES[game.game_id])
            ? storedIcon
            : (ADMIN_V2_ICON_OVERRIDES[game.game_id] || meta.icon || "🎮"),
